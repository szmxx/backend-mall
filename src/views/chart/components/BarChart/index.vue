...
import { X_AXIS, Y_AXIS, GRID, TOOLTIP, LEGEND, SERIES_STYLE } from '../config'
import { BAR_SERIES_STYLE, BAR_TOOLTIP } from './config'
...
function onOption(_option: Record<string, unknown>) {
  ...
  tooltip = Object.assign({}, TOOLTIP, BAR_TOOLTIP, tooltip || {})
  legend = Object.assign({}, LEGEND, legend || {})
  grid = Object.assign({}, GRID, grid || {})
  xAxis = Array.isArray(xAxis)
    ? xAxis.map((item) => Object.assign({}, X_AXIS, item || {}))
    : Object.assign({}, X_AXIS, xAxis || {})
  yAxis = Array.isArray(yAxis)
    ? yAxis.map((item) => Object.assign({}, Y_AXIS, item || {}))
    : Object.assign({}, Y_AXIS, yAxis || {})
  series = Array.isArray(series)
    ? series.map((item, index) =>
        Object.assign({}, SERIES_STYLE(index), BAR_SERIES_STYLE, item || {}),
      )
    : [Object.assign({}, SERIES_STYLE(0), BAR_SERIES_STYLE, series || {})]
