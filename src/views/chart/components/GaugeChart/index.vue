...
import { GAUGE_SERIES_STYLE, GAUGE_TOOLTIP } from './config'
...
function onOption(_option: Record<string, unknown>) {
  let { tooltip = {}, legend = {}, grid = {}, series = [] } = _option || {}
  tooltip = Object.assign({}, TOOLTIP, GAUGE_TOOLTIP, tooltip || {})
  legend = Object.assign({}, LEGEND, legend || {})
  grid = Object.assign({}, GRID, grid || {})
  series = Array.isArray(series)
    ? series.map((item, index) =>
        Object.assign({}, GAUGE_SERIES_STYLE(index), item || {}),
      )
    : [Object.assign({}, GAUGE_SERIES_STYLE(0), series || {})]
