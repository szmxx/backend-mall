...
import { LINE_SERIES_STYLE, LINE_TOOLTIP } from './config'
...
function onOption(_option: Record<string, unknown>) {
  ...
  tooltip = Object.assign({}, TOOLTIP, LINE_TOOLTIP, tooltip || {})
  ...
  series = Array.isArray(series)
    ? series.map((item, index) =>
        Object.assign(
          {},
          SERIES_STYLE(index),
          LINE_SERIES_STYLE(index),
          item || {},
        ),
      )
    : [Object.assign({}, SERIES_STYLE(0), LINE_SERIES_STYLE(0), series || {})]
