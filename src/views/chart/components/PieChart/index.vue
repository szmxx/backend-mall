...
import { PIE_SERIES_STYLE, PIE_TOOLTIP } from './config'
...
function onOption(_option: Record<string, unknown>) {
  ...
  tooltip = Object.assign({}, TOOLTIP, PIE_TOOLTIP, tooltip || {})
  legend = Object.assign({}, LEGEND, legend || {})
  grid = Object.assign({}, GRID, grid || {})
  series = Array.isArray(series)
    ? series.map((item) => Object.assign({}, PIE_SERIES_STYLE, item || {}))
    : [Object.assign({}, PIE_SERIES_STYLE, series || {})]
